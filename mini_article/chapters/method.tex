...
\subsection{Banco de dados usado na busca}
    ...
    um mecanismo de busca online gratuito que permite 
...
\subsection{Termos de busca}
    Os termos de busca usados foram escolhidos com base
    na proposta inicial de explorar DDA em jogos, 
    sendo eles:
    ...
    periódicos e conferências publicados em inglês no 
    período entre 2020 e 2026.
...
\subsection{Critérios de inclusão e exclusão}
    ...
    também foram incluídas publicações em periódicos e 
...
\subsection{Processo de triagem}
    Depois da aplicação dos termos de busca 
    estabelecidos, a seleção foi feita por meio da 
    análise do abstract do artigo e da sua conclusão 
    para determinar sua relevância para a proposta. 
    
    Após essa avaliação inicial, restaram seis publicações que 
